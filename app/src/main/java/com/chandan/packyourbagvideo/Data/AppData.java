package com.chandan.packyourbagvideo.Data;

import android.app.Application;
import android.content.Context;
import android.widget.Toast;

import com.chandan.packyourbagvideo.Constants.MyConstants;
import com.chandan.packyourbagvideo.Database.RoomDB;
import com.chandan.packyourbagvideo.Models.Items;
...
public class AppData extends Application {
    ...
    public List<Items> getPersonalCareData(){
        String []data = {"Tooth-brush", "Tooth-paste", "Floss", "Mouthwash","Shaving Cream","Razor Blade","Soap","Fiber","Shampoo","Hair Conditioner",
        "Brush","Comb","Hair Dryer","Curling Iron","Hair Moulder","Hair Clip","Moisturizer","Lip Cream","Contact Lens",
        "Perfume","Deodorant","Makeup Materials","Makeup Remover","Wet Wipes","Pad","Ear Stick","Cotton","Nail Polish",
    ...
    public List<Items> getClothingDta(){
        String []data = {"Stockings","Underwear","Pajamas","T-Shirts","Casual Dress","Evening Dress",
        "Shirt","Cardigan","Vest","Jacket","Skirt","Trousers","Jeans","Shorts","Suit","Coat","Rain Coat",
        "Glove","Hat","Scarf","Bikini","Belt","Slipper","Sneakers","Casual Shoes","Heeled Shoes","Sports Wear"};
    ...
    public List<Items> getBabyNeedsData(){
        ...
        "Brest-feeding Cover","Breast Pump","Water Bottle","Storage Container","Baby Food Spoon","Highchairs","Diaper",
        "Wet Wipes","Baby Cotton","Baby Care Cover","Baby Shampoo","Baby soap","Baby Nail Scissors","Body Moisturizer",
        "Potty","diaper Rash Cream","Serum Physiological","Nasal Aspirator","Fly Repellent Lotion","Pyrometer","Antipyretic Syrup",
        "Probiotic Power","Baby Backpack","Stroller","Baby Carrier","Toys","Teether","Playpen","Playpen","Baby Radio",
    ...
    public List<Items> getHealthData() {
        String []data = {"Aspirin","Drugs Used","Vitamins Used","Lens Solutions","Condom","Hot Water Bag","Tincture Of Lodine",
    ...
    public List<Items> getTechnologyData() {
        ...
        "Battery","Power Bank","DVD Player","Flash-Light","MP3 Player","Mp3 Player Charger","Voltage Adapter","SD Card"};
    ...
    public List<Items> getBeachSuppliesData() {
        ...
        "Beach Slippers","Sunbed","Snorkel","Waterproof Clock"};
    ...
    public List<List<Items>> getAllData(){
        ...
        listOfAllItems.add(getClothingDta());
